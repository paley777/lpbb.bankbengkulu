        ...
        <div class="row justify-content-center">
            <div class="col-sm-4-text-center  col-md-3 text-lg-start d-flex flex-column">
                ...
                <ul class="list-unstyled">
                    <li data-bss-hover-animate="pulse"><a class="link-light"
                            href="https://bankbengkulu.co.id/">https://bankbengkulu.co.id/</a></li>
                </ul>
                <ul class="list-unstyled">
                    <li data-bss-hover-animate="pulse"><a class="link-light"
                            href="https://asbanda.org/">https://asbanda.org/</a></li>
                </ul>
            </div>
                ...
                <div class="fw-bold d-flex align-items-center mb-2">
                    <a class="navbar-brand d-flex align-items-center" data-bss-hover-animate="pulse" href="/">
                        <img src="{{ asset('storage/images/logo_white.png') }}" alt="Logo" width="216"
                            height="48" class=""></a>
                    <a class="navbar-brand d-flex align-items-center" data-bss-hover-animate="pulse" href="/">
                        <img src="{{ asset('storage/images/bpd.png') }}" alt="Logo" width="135" height="57,6"
                            class=""></a>
                </div>
                <p class="text-white">Learning Program Bank Bengkulu adalah program pengembangan sumber daya manusia
        ...
        <div class="d-flex justify-content-between align-items-center pt-3">
            ...
            <ul class="list-inline mb-0">
                <li class="list-inline-item">
                    <a class="navbar-brand" href="https://bankbengkulu.co.id/">
                ...
                <li class="list-inline-item">
                    <a class="navbar-brand" href="https://www.instagram.com/bankbengkulu_diklat/">
