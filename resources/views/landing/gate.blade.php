            ...
            <div class="row gx-lg-5 align-items-center mb-5">
                <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                    <h1 class="responsive-header fw-bold" style="color: hsl(218, 81%, 95%)">
                        Anda mencoba masuk ke sistem?
                    </h1>
                    <p class="mb-4 responsive-small opacity-70" style="color: hsl(218, 81%, 85%)">
                        Jawablah pertanyaan singkat yang tertera di laman ini.
                    </p>
                </div>
                    ...
                    <div class="card bg-glass">
                        <div class="card-body px-4 py-5 px-md-5">
                            ...
                            <form method="POST" action="/gate">
                                @csrf
                                <p class="responsive-small">{{ $gate->soal }}</p>
                                <p class="responsive-small">Jawaban Anda:</p>
                                <div class="form-outline mb-4">
                                    <input type="text" name="answer" class="form-control" required />
                                    <input type="text" name="id" value="{{ $gate->id }}" class="form-control"
                                        required hidden />
                                </div>
                                <button type="submit"
