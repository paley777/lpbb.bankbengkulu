...
@section('container')
    ...
    <style>
        ...
        @keyframes typing {
            ...
            59.2558%,
            70.6512% {
                content: "E-Learning B";
            }

            60.3953%,
            69.5116% {
                content: "E-Learning Ba";
            }

            61.5349%,
            68.3721% {
                content: "E-Learning Ban";
            }

            78.6279%,
            96.8605% {
                content: "E-Learning Bank";
            }

            79.7674%,
            95.7209% {
                content: "E-Learning Bank Be";
            }

            80.9070%,
            94.5814% {
                content: "E-Learning Bank Beng";
            }

            82.0465%,
            93.4419% {
                content: "E-Learning Bank Bengk";
            }

            83.1860%,
            92.3023% {
                content: "E-Learning Bank Bengku";
            }
            ...
            <div class="row h-100">
                <div
                    ...
                    <div>
                        ...
                        <p class="fw-semibold mb-4 responsive-p" style="color: rgb(255,255,255);">Sistem
                            pembelajaran satu atap bagi pegawai Bank Bengkulu. Ikuti beragam kelas materi yang mampu
                            meningkatkan kompetensi Anda! Tersedia mulai dari tahap pembelajaran hingga sertifikasi.</p>
                        <a href="/materi"
    ...
    <div class="container px-0 mx-0" style="max-width: 100%;">
        <div class="magicpattern text-center text-white-50 border-0 p-5 align-middle">
            <div class="row row-cols-2 row-cols-md-4 p-5 px-5 mx-5"
                style="position: relative;display: padding-top: 14px;">
                <div class="col">
                    <div class="p-3">
                        <h4 class="fw-bold text-white mb-0 responsive-header1" id="counter1">3.822</h4>
                        <p class="fw-bold text-white mb-0 responsive-mini">Pengguna Terdaftar</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="fw-bold text-white mb-0 responsive-header1" id="counter2">24</h4>
                        <p class="fw-semibold text-white mb-0 responsive-mini">Kelas Materi</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="fw-bold text-white mb-0 responsive-header1" id="counter3">230</h4>
                        <p class="fw-semibold text-white mb-0 responsive-mini">Topik Materi</p>
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <h4 class="fw-bold text-white mb-0 responsive-header1" id="counter4">1.080</h4>
                        <p class="fw-semibold text-white mb-0 responsive-mini">Sertifikat Dikeluarkan</p>
                    </div>
                </div>
            </div>
        </div>
