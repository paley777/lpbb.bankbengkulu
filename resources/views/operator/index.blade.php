                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-md-12 col-12">
                                    <div class="card text-white bg-success bg-gradient h-100">
                                        <div class="card-body">
                                            <h4 class="card-title">Pegawai Terdaftar ({{ Auth::user()->unit_kerja }})
                                            </h4>
                            ...
                            <div class="row g-2">
                                <div class="col">
                                    <div class="card rounded">
                                        <h4 class="card-title">Grafik Perbandingan Post Test (Lulus vs Tidak Lulus/Belum
                                            Lulus)</h4>
