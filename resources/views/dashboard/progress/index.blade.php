                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb responsive-small">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Manajemen Kemajuan Pembelajaran</li>
                        </ol>
                    </nav>
                    <div class="card text-bg-success bg-gradient mb-3 bg-opacity-100">
                        ...
                        <div class="card-body">
                            <h4 class=" responsive-p1 fw-semibold mb-3">Manajemen Kemajuan Pembelajaran</h4>
