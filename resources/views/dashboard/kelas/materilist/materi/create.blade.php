            ...
            <div class="row mx-4">
                <div class="col">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Tambah Materi</h4>
                            </div>
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post"
                                action="/dashboard/materi-list/{{ $kelas }}/create-materi"
                                ...
                                <div class="col-md-12 position-relative">
                                    ...
                                    <div class="form-check">
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="nama_materi" placeholder="Isi Nama Materi" required>
                                    </div>
