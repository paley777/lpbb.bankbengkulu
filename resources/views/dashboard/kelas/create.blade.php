            ...
            <div class="row mx-4">
                <div class="col">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Tambah Kelas</h4>
                            </div>
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post" action="/dashboard/kelas">
                                @csrf
                                <div class="col-md-8 position-relative">
                                    ...
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                        name="nama_modul" placeholder="Isi Nama Kelas" required>
                                </div>
                                <div class="col-md-2 position-relative">
                                    ...
                                    <input type="date" id="validationCustom01" class="form-control responsive-small"
                                        name="date_start" placeholder="Isi Tanggal Mulai" required>
                                </div>
                                <div class="col-md-2 position-relative">
                                    <label for="validationCustom01" class="form-label">Tanggal Selesai<span
                                            class="text-danger">*</span></label>
                                    <input type="date" id="validationCustom01" class="form-control responsive-small"
                                        name="date_end" placeholder="Isi Tanggal Selesai" required>
                                </div>
                                <div class="col-md-12 position-relative">
                                    ...
                                    <textarea class="form-control responsive-small" id="floatingTextarea2" name="deskripsi"
                                        placeholder="Isi Deskripsi Kelas" required style="height: 100px"></textarea>
                                </div>
                                <p>
