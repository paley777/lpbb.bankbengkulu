            ...
            <div class="row mx-4">
                <div class="col">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Edit Soal</h4>
                            </div>
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post"
                                action="/dashboard/soal/{{ $soal->id }}">
                                @method('put')
                                @csrf
                                <div class="col-md-12 position-relative">
                                    ...
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                        name="nama_bank" value="{{ $soal->nama_bank }}" placeholder="Isi Nama Bank" required
                                        readonly hidden>
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                    ...
                                    <textarea class="form-control responsive-small" id="floatingTextarea2" name="soal" placeholder="Isi Soal" required
                                        style="height: 100px">{{ $soal->soal }}</textarea>
                                </div>
                                @csrf
                                <div class="col-md-12 position-relative">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="correct_ans" value="B" id="flexRadioDefault2"
                                                                checked>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="correct_ans" value="C" id="flexRadioDefault3"
                                                                checked>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="correct_ans" value="D" id="flexRadioDefault4"
                                                                checked>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control responsive-small" id="floatingTextarea2" name="ans_a" placeholder="Isi Opsi A" required
                                                            style="height: 100px">{{ $soal->ans_a }}</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control responsive-small" id="floatingTextarea2" name="ans_b" placeholder="Isi Opsi B"
                                                            required style="height: 100px">{{ $soal->ans_b }}</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control responsive-small" id="floatingTextarea2" name="ans_c" placeholder="Isi Opsi C"
                                                            required style="height: 100px">{{ $soal->ans_c }}</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control responsive-small" id="floatingTextarea2" name="ans_d" placeholder="Isi Opsi D"
                                                            required style="height: 100px">{{ $soal->ans_d }}</textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <button class="btn btn-outline-primary responsive-small fw-semibold" type="submit">
                                        Simpan Data <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20 4L3 9.31372L10.5 13.5M20 4L14.5 21L10.5 13.5M20 4L10.5 13.5" stroke="#0275d8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                    </button>
                            </form>
                        </div>
                    </div>
