                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb responsive-small">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Bank Soal</li>
                        </ol>
                    </nav>
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Edit Bank Soal</h4>
                            </div>
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post"
                                action="/dashboard/bank-soal/{{ $bank->id }}">
                                @method('put')
                                @csrf
                                <div class="col-md-6 position-relative">
                                    ...
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                        name="nama_bank" value="{{ old('nama_bank', $bank->nama_bank) }}"  placeholder="Isi Nama Bank" required>
                                </div>
