            ...
            <div class="row mx-4">
                <div class="col">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Tambah Pre Test</h4>
                            </div>
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post" action="/dashboard/pre-test">
                                @csrf
                                <div class="col-md-6 position-relative">
                                    ...
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                        name="nama_pretest" placeholder="Isi Nama Pre Test" required>
                                </div>
                                <div class="col-md-3">
