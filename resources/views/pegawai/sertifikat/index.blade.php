                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb responsive-small">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sertifikat Pribadi</li>
                        </ol>
                    </nav>
                    <div class="card text-bg-success bg-gradient mb-3 bg-opacity-100">
                        ...
                        <div class="card-body">
                            <h4 class=" responsive-p1 fw-semibold mb-3">Sertifikat Pribadi</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="col-lg-5 col-md-4 me-3">
                                    <form action="/my-certificate">
                                        <div class="input-group">
                                            <input type="text" class="form-control responsive-small"
                                                placeholder="Cari Berdasarkan Nama Kelas" name="search1"
