            ...
            <div class="row mx-4">
                <div class="col">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title fw-semibold responsive-p1 me-3">Post Test</h4>
                            </div>
                            <hr>
                            <table class="table table-hover responsive-small">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Nama Ujian</td>
                                        <td>:</td>
                                        <td>{{ $posttest_info->nama_posttest }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2
                            ...
                            <form name="quiz" class="row g-2 responsive-small fw-semibold" method="post"
                                action="/kelas/{{ $kelas->id }}/room/{{ $materi->id }}/posttest-remedial">
                                @csrf
                                ...
                                <button class="btn btn-outline-primary responsive-small fw-semibold" type="submit"
                                    ...
                                    Selesai <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20 4L3 9.31372L10.5 13.5M20 4L14.5 21L10.5 13.5M20 4L10.5 13.5" stroke="#0275d8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                </button>
                        </div>
                    </div>
                </div>
